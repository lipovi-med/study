...
void MainWindow::on_pb_request_clicked()
{
    ...
    ///
    /// закинуть данные что бд должна отдать
    /// По идее сюда нужно добавить данные от сомбо бокса
    switch(ui->cb_category->currentIndex()){
        ...
        case requestType::requestComedy:
            emit sig_RequestToDb(request + " WHERE c.name = 'Comedy'");
            break;
        case requestType::requestHorrors:
            emit sig_RequestToDb(request + " WHERE c.name = 'Horror'");
            break;
    }
